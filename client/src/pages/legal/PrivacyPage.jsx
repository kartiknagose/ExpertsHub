...
export function PrivacyPage() {
  ...
  return (
    ...
    >
      ...
      <p>
        We collect information you provide directly, such as your name, email address, mobile number, and payment details when you register for or use UrbanPro. We also collect information about how you use our platform, including bookings made, services browsed, and communications with professionals.
      </p>
      ...
      <h2>5. Your Rights</h2>
      <p>
        You may request access to, correction of, or deletion of your personal data at any time by contacting us at <strong>privacy@urbanpro.com</strong>. We will respond within 30 days.
      </p>
      ...
      <h2>7. Contact Us</h2>
      <p>
        Questions about this policy? Email us at <strong>privacy@urbanpro.com</strong> or write to our registered office.
      </p>
    </LegalLayout>
  );
}
